...
# loading the data
cars = pd.read_csv("C:\\Users\\praka\\Downloads\\coach\\multi\\cars.csv")
...
vif_sp = 1/(1-rsq_sp) #  16.35
 ...
 # tabulate the values          # Storing vif values in a data frame
d1 = {'Variables':['Hp','WT','VOL','SP'],'VIF':[vif_hp,vif_wt,vif_vol,vif_sp]}
Vif_frame = pd.DataFrame(d1)  
Vif_frame
 
# for only seeingg in one row
# vif degree of collinearity 
# avf show which is least 
...
# Checking Residual or error are normally distributed
